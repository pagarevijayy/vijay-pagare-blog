...
**Key Learning:**  There was an initial hesitation to fully trust the simulation approach — it felt too "simple" or brute-force. However, this solution is already **asymptotically optimal (O(n × m))**, which means there is no need to over-optimize further.
